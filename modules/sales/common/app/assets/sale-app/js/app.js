		...
		.factory('API', ['$http', 'Upload', function($http, Upload) {
			return {
				...
				loadProducts:     function(type_id, category_id) {
					return $http.get(apiUrl(settings.api.products), {params: {typeId: type_id, categoryId: category_id, promotionId:settings.promotion_id}});
				},
				loadCategories:   function(type_id) {
					return $http.get(apiUrl(settings.api.categories), {params: {typeId:type_id, promotionId:settings.promotion_id}});
				},
				loadTypes:        function() {
