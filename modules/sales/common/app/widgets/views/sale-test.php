...
\modules\sales\common\app\assets\SaleTestAsset::register($this);
...
<div class="sale-form" ng-app="SaleEditApplication" ng-controller="SaleEdit">
	...
	<form class="form-horizontal">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<div class="form-group" style="padding-left:16px">
					<div class="radio">
						<label>
							<input type="radio" name="type" value="default" ng-model="type" ng-change="typeDefault()">
							Товарные позиции
						</label>
					</div>
					<div class="radio">
						<label>
							<input type="radio" name="type" value="brands" ng-model="type" ng-change="typeBrands()">
							Торговые марки
						</label>
					</div>
				</div>
		...
		<div class="panel panel-default" ng-show="type == 'default'">
			<div class="panel-heading">
				Товарные позиции
			</div>
			<div class="panel-body">
					...
					<tr ng-repeat="position in model.positions">
						...
						<td>
							<div class="input-group">
								...
								<div class="input-group-addon" ng-show="position.type">кг</div>
							</div>
						</td>
						<td>
		...
		<div class="panel panel-default" ng-show="type == 'brands'">
			<div class="panel-heading">
				Торговые марки
			</div>
			<div class="panel-body">
						...
						<div class="thumbnail">
							<a href="/sales/sales/download-document?id={{ document.id }}" target="_blank"
							   ng-if="document.uploaded">
								<img src="/sales/sales/download-document?id={{ document.id }}" ng-if="document.isImage"/>
