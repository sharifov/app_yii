...
/**
 * FactorSearch represents the model behind the search form about `modules\sales\common\models\Factor`.
 */
class FactorSearch extends Factor implements SearchModelInterface

{
    ...
    {
        return [
            [['id', 'x', 'dealer_id', 'brand_id'], 'integer'],
        ];
    }
