...
use modules\sales\common\models\Region;

/**
 * RegionSearch represents the model behind the search form about `modules\sales\common\models\Region`.
 */
class RegionSearch extends Region implements SearchModelInterface
