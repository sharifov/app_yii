...
/**
 * TypeSearch represents the model behind the search form about `modules\sales\common\models\Type`.
 */
class TypeSearch extends Type implements SearchModelInterface
