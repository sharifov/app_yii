...
/**
 * BrandSearch represents the model behind the search form about `modules\sales\common\models\Brand`.
 */
class BrandSearch extends Brand implements SearchModelInterface
