...
/**
 * PromotionRuleSearch represents the model behind the search form about `modules\sales\common\models\PromotionRule`.
 */
class PromotionRuleSearch extends PromotionRule implements SearchModelInterface

{
    ...
    {
        return [
            [['id', 'promotion_id', 'priority'], 'integer'],
            [['condition', 'rule'], 'safe'],
        ];
    }
