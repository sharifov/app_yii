...
/**
 * PromotionSearch represents the model behind the search form about `modules\sales\common\models\Promotion`.
 */
class PromotionSearch extends Promotion implements SearchModelInterface
